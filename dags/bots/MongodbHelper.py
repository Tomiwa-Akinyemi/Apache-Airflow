...
#     insert_single_doc("ChicagoCrime1",{"ID":7397342,"Case Number":"YW352891","Date":"08/10/2022 16:00","Primary Type":"RAPE","Latitude":41.78033068,"Longitude":-87.68489178,"Location":"(41.780330681, -87.684891779)"})

def select_multiple_doc(collection_name, query, projection=None):
    collection_data = None
    try:
        db_name = get_connection()
        collection_name=db_name[collection_name]
        print(collection_name)
        collection_data = collection_name.find(query,projection)
    except Exception as exc:
        print(exc)
    return collection_data
